...
class TestDevice2(stidevicepy.LocalDevice):
    def __init__(self, config):
        ...
        self.addOutputChannel(0, stipy.MixedValueType.Double, "coil current on partber")       #outputs a Double
...
class TestDeviceOutputEvent(stidevicepy.SynchronousEvent):
    ...
    def loadEvent(self):
        ...
        for channel, value in self.values.items():
            print("PARTNER: Loading channel #" + str(channel) + " with value " + str(value) + ".")
        return
    ...
    def playEvent(self):
        ...
        for channel, value in self.values.items():
            print("PARTNER:  Playing channel #" + str(channel) + " with value " + str(value) + ".")
