...
STIPyShot::STIPyShot(const std::shared_ptr<STI::Engine::Shot>& shot, const std::string& name)
...
std::vector<STI::Python::ParsedVarPy> STIPyShot::getVars()
{
    std::vector<STI::Python::ParsedVarPy> vars;
