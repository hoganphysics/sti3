...
void init_Configuration(py::module& m) 
{
    ...
    py::class_<ConfigFile, Configuration>(m, "ConfigFile")
        ...
        .def("load", py::overload_cast<bool>(&ConfigFile::load), py::arg("autocreate"))
        .def("load", py::overload_cast<const std::string&, bool>(&ConfigFile::load), py::arg("filename"), py::arg("autocreate"))
