...
//void TDeviceEventHandler_i::addEvent(const ::CORBA::Any& evt)
...
//	STI::Device::DeviceEventType tmp1;
//	STI::TNetwork::TDeviceEventType tmp2;

//	convert<STI::Device::DeviceEventType, STI::TNetwork::TDeviceEventType>(tmp1, tmp2);
