...
//Abstract interface for extracting TParsedShot references from appropriate ParsedShot pointers
class TParsedShotRefInterface
{
public:

	static bool getTParsedShotReference(const typename std::shared_ptr<STI::Engine::ParsedShot>& shot, STI::TNetwork::TParsedShot_ptr& tShot)
	{
