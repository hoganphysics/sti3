...
public class StringMap extends java.util.AbstractMap<String, String> {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        stiJNI.delete_StringMap(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public StringMap() {
    this(stiJNI.new_StringMap__SWIG_0(), true);
  }

  public StringMap(StringMap other) {
    this(stiJNI.new_StringMap__SWIG_1(StringMap.getCPtr(other), other), true);
  }
  ...
  static protected class Iterator {
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          stiJNI.delete_StringMap_Iterator(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
    ...
    private StringMap.Iterator getNextUnchecked() {
      return new StringMap.Iterator(stiJNI.StringMap_Iterator_getNextUnchecked(swigCPtr, this), true);
    }
  
    private boolean isNot(StringMap.Iterator other) {
      return stiJNI.StringMap_Iterator_isNot(swigCPtr, this, StringMap.Iterator.getCPtr(other), other);
    }
  
    private String getKey() {
      return stiJNI.StringMap_Iterator_getKey(swigCPtr, this);
    }
  
    private String getValue() {
      return stiJNI.StringMap_Iterator_getValue(swigCPtr, this);
    }
  
    private void setValue(String newValue) {
      stiJNI.StringMap_Iterator_setValue(swigCPtr, this, newValue);
    }
  
  }

  public boolean isEmpty() {
    return stiJNI.StringMap_isEmpty(swigCPtr, this);
  }

  public void clear() {
    stiJNI.StringMap_clear(swigCPtr, this);
  }

  private StringMap.Iterator find(String key) {
    return new StringMap.Iterator(stiJNI.StringMap_find(swigCPtr, this, key), true);
  }

  private StringMap.Iterator begin() {
    return new StringMap.Iterator(stiJNI.StringMap_begin(swigCPtr, this), true);
  }

  private StringMap.Iterator end() {
    return new StringMap.Iterator(stiJNI.StringMap_end(swigCPtr, this), true);
  }

  private int sizeImpl() {
    return stiJNI.StringMap_sizeImpl(swigCPtr, this);
  }

  private boolean containsImpl(String key) {
    return stiJNI.StringMap_containsImpl(swigCPtr, this, key);
  }

  private void putUnchecked(String key, String value) {
    stiJNI.StringMap_putUnchecked(swigCPtr, this, key, value);
  }

  private void removeUnchecked(StringMap.Iterator itr) {
    stiJNI.StringMap_removeUnchecked(swigCPtr, this, StringMap.Iterator.getCPtr(itr), itr);
  }
