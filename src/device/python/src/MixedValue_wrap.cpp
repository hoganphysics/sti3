...
void init_MixedValue(py::module& m) 
{
    ...
    py::class_<MixedValuePy>(m, "MixedValue")
        ...
        .def("setValue", py::overload_cast<const MixedValuePy&>(&MixedValuePy::setValue_py))    //, py::keep_alive<1, 2>()
        .def("setValue", py::overload_cast<const py::object&>(&MixedValuePy::setValue_py))
        .def("addValue", py::overload_cast<const MixedValuePy&>(&MixedValuePy::addValue_py))
        .def("addValue", py::overload_cast<const py::handle&>(&MixedValuePy::addValue_py))
