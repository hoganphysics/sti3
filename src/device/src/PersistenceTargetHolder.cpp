...
PersistenceTargetHolder::PersistenceTargetHolder(const std::shared_ptr<PersistenceTarget>& target)
: target(target)
{
...
void PersistenceTargetHolder::load(const std::string& basePath)
{
    if (target != 0) {
